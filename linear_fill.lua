...
local function fill (pos, item, length, dir, player, pointed_thing)
...
local function on_place (itemstack, placer, pointed_thing)
	...
	if count and look_dir then
		...
		fill (above, stack, count, look_dir, placer, pointed_thing)

		minetest.log ("action", string.format ("lwcreative_tools linear fill by %s with %s at %s, length %d",
...
minetest.register_craftitem ("lwcreative_tools:linear_fill", {
	description = "Linear Fill",
	short_description = "Linear Fill",
	groups = { },
	inventory_image = "lwcreative_tools_linear_fill.png",
	wield_image = "lwcreative_tools_linear_fill.png",
